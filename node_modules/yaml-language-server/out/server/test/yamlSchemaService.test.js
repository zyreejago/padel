  ...
  to:
    ...
    weight: 100`;
        ...
        `);
            ...
            expect(resolvedSchema.schema.url).eqls(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json#/definitions/io.k8s.api.admissionregistration.v1.MutatingWebhook');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.KUBERNETES_SCHEMA_URL);
            expect(requestServiceMock).calledWithExactly('file:///_definitions.json');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json#/definitions/io.k8s.api.admissionregistration.v1.MutatingWebhook');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json');
        ...
        `);
            ...
            service.registerExternalSchema(schemaUrls_1.KUBERNETES_SCHEMA_URL, ['*.yaml']);
            const resolvedSchema = await service.getSchemaForResource('test.yaml', yamlDock.documents[0]);
            expect(resolvedSchema.schema.url).eqls(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json#/definitions/io.k8s.api.apps.v1.Deployment');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.KUBERNETES_SCHEMA_URL);
            expect(requestServiceMock).calledWithExactly('file:///_definitions.json');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json#/definitions/io.k8s.api.apps.v1.Deployment');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json');
            expect(requestServiceMock.callCount).equals(4);
        });
        ...
        `);
            ...
            service.registerExternalSchema(schemaUrls_1.KUBERNETES_SCHEMA_URL, ['*.yaml']);
            const resolvedSchema = await service.getSchemaForResource('test.yaml', yamlDock.documents[0]);
            expect(resolvedSchema.schema.url).eqls(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json#/definitions/io.k8s.api.rbac.v1.RoleBinding');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.KUBERNETES_SCHEMA_URL);
            expect(requestServiceMock).calledWithExactly('file:///_definitions.json');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json#/definitions/io.k8s.api.rbac.v1.RoleBinding');
            expect(requestServiceMock).calledWithExactly(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json');
            expect(requestServiceMock.callCount).equals(4);
        });
    ...
    resource:
      ...
      target:
        ...
        averageUtilization: 80`;
            ...
            settings.kubernetesCRDStoreEnabled = true;
            requestServiceMock = sandbox.fake((uri) => {
                if (uri === schemaUrls_1.KUBERNETES_SCHEMA_URL) {
    ...
    "x-kubernetes-group-version-kind": [
      {
        ...
        "version": "v2"
            ...
            service.registerExternalSchema(schemaUrls_1.KUBERNETES_SCHEMA_URL, ['*.yaml']);
            const resolvedSchema = await service.getSchemaForResource('test.yaml', yamlDock.documents[0]);
            expect(resolvedSchema.schema.url).eqls(schemaUrls_1.BASE_KUBERNETES_SCHEMA_URL + '_definitions.json#/definitions/io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler');
        });
    });
});
