...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-json-languageservice/lib/umd/services/jsonSchemaService", "../jsonSchema", "../yamlLanguageService", "@vscode/l10n", "path", "vscode-uri", "./modelineUtil", "ajv", "ajv-draft-04", "ajv/dist/2019", "ajv/dist/2020", "jsonc-parser", "yaml", "../utils/schemaUrls", "./k8sSchemaUtil"], factory);
    }
    ...
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    const ajvLocalizers = require('ajv-i18n');
    ...
    class YAMLSchemaService extends jsonSchemaService_1.JSONSchemaService {
        ...
        async resolveSchemaContent(schemaToResolve, schemaURL, dependencies) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
                ...
                const _handleRef = (next, nodeBaseUri, nodeSourceUri, nodeDialect, recursiveAnchorBase, inheritedDynamicScope, siblingRefCycleKeys) => {
                ...
                while (toWalk.length) {
                    ...
                    if (seen.has(next))
                        continue;
                    seen.add(next);
                    _handleRef(next, nodeBaseUri, nodeSourceUri, nodeDialect, nodeRecursiveAnchorBase, item.inheritedDynamicScope, item.siblingRefCycleKeys);
                }
                        ...
                        for (const schemaId of entry.getURIs()) {
                            if (!seen[schemaId]) {
                                if (this.yamlSettings?.kubernetesCRDStoreEnabled && schemaId === schemaUrls_1.KUBERNETES_SCHEMA_URL) {
                                    ...
                                    const kubeSchema = (0, k8sSchemaUtil_1.autoDetectKubernetesSchema)(doc, k8sAllSchema, this.yamlSettings.kubernetesCRDStoreUrl ?? schemaUrls_1.CRD_CATALOG_URL);
                                    if (kubeSchema) {
    ...
    function getAjvLocalizer(locale) {
        if (!locale)
            return undefined;
    ...
    function localizeAjvErrors(errors, locale) {
